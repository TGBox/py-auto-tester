...
from py_auto_tester.core.codegen_recorder import CodegenRecorder

from py_auto_tester.gui.tree_manager import TreeManagerWidget
from py_auto_tester.gui.routine_editor import RoutineEditorWidget
from py_auto_tester.gui.runner_widget import RunnerWidget
from py_auto_tester.gui.dataset_editor import DatasetEditorWidget
from py_auto_tester.gui.styles import DARK_THEME_QSS
...
class MainWindow(QMainWindow):
    ...
    def show_load_warnings(self):
        """Zeigt beim Start, wenn eine Projektdatei beschädigt war."""
        warnings = self.pm.drain_load_warnings()
        if not warnings:
            return
        QMessageBox.warning(
            self, "Projektdateien",
            "Beim Laden des Projekts gab es Probleme:\n\n"
